module "run_command" {
  ...
  ignore_body_changes          = var.ignore_body_changes.compute_virtual_machines_run_commands
  ...
  resource_types               = var.resource_types.compute_virtual_machines_run_commands
  retry                        = var.retry
